...
GROUP BY c.customer_id, c.email, customer_name;
...
FROM rental_summary rs                    -- usar la VIEW del Step 1
JOIN payment p ON rs.customer_id = p.customer_id  -- unimos con payment
